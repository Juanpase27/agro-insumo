...
@section('content')
    ...
    <div class="row" style="margin: 0px">
        <div class="col-3">
            <a href="{{route('supplies.index')}}"  style="color: #959595; "> < Volver</a>
        </div>
        <div class="col-6">
    ...
    <div class="col-md-12 mt-4">
        <div class="card p-3 mb-2" style="margin: 0 18%">
            ...
            <div class="row">
                <div class="col-6">
                    <button type="submit" class="btn mt-3" onclick="redirectToUpdatePage({{ $supply->id }})" style="border-color:#093064">Actualizar</button>
                </div>
                <div class="col-6">
                    <form action="{{ route('products.destroy', $supply) }}" method="POST">
                        @csrf
                        @method('delete')
