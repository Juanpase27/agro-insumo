        ...
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Agro Insumo</span> </a>
                <div class="nav_list">
                    ...
                    <a href="{{route('contact.index')}}" class="{{request()->routeIs('contact.*') ? 'active' : '' }} nav_link"> <i class='bx bx-bar-chart-alt-2 nav_icon'></i> <span class="nav_name">Contáctanos</span> </a>
                </div>
