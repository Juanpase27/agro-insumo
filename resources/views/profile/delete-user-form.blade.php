    ...
    <x-slot name="title">
        <div class="row">
            <div class="col-lg-3 col-md-12">
                <h4 class="font-color-titles">{{ __('Delete Account') }}</h4>
            </div>
...
<div class="container">
    <div class="row">
        <div class="col-lg-3 col-md-12">
            <h4 class="font-color-titles" style="text-align: initial;">{{ __('Delete Account') }}</h4>
        </div>
        <div class="col-lg-9 col-md-12">
            <hr style="border-color: white; background: #61a851; height: 4%;" />
        </div>
    ...
    <p style="text-align: initial;">
        {{ __('Permanently delete your account.') }}</p>
